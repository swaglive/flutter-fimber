...
void main() async {
  ...
  group('File logs.', () {
    ...
    test('Old file detection test', () async {
      ...
      expect(
        logTree.isLogFile('$testDirName$dirSeparator$fileName.txt'),
        true,
      );
      expect(
      ...
      final logFile1 = logTree.logFileFromId(fileId1);
      ...
      final logFile2 = logTree.logFileFromId(fileId2);
      ...
      final logFile3 = logTree.logFileFromId(fileId3);
      print(logFile3);
      expect(
        logFile3,
...
Future waitForAppendBuffer({int? bufferFlushInterval}) async {
  await Future.delayed(
    Duration(
      milliseconds: bufferFlushInterval ?? FileTree.defaultBufferFlushInterval,
    ),
  );
}
